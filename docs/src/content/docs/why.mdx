...
import banner from '../../assets/why-banner.jpeg';
import { Image } from 'astro:assets';

<Image src={banner} alt="Why Missive.js?" />
...
<Aside type="tip">
In summary: `Commands` change data, `Queries` retrieve data. `Events` notify the system when changes happen.
</Aside>
...
3. **Clean Architecture**: Missive.js promotes Clean Architecture principles by providing a clear separation of concerns and a structured way to
   handle Commands, Queries, and Events. This separation makes it easier to maintain and extend your application as it grows.
...
- [CQRS by Martin Fowler](https://martinfowler.com/bliki/CQRS.html): A detailed explanation of the CQRS pattern by Martin Fowler.
